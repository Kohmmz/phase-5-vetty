...
def auto_login():
    ...
    # Original: identity = 1  # JWT DISABLED: Replaced get_jwt_identity() with hardcoded user ID
...
def current_user():
    ...
    # Original: current_user_id = 1  # JWT DISABLED: Replaced get_jwt_identity() with hardcoded user ID

    # Using hardcoded user_id for testing without JWT

    current_user_id = 1  # Hardcoded user_id for testing
